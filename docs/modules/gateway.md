...
**AI-роуты (`src/routes/ai.routes.ts`, Phase 5B/5D/5E):**
...
Остальные публичные роуты появятся в Phase 5F-G и 6-7 (`/ai/discuss`, `/ai/pack-into-project`, `/ai/develop-suggestions`, `/projects/*`, `/links/*`).
